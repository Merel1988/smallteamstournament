...
- Lokaal end-to-end geverifieerd (screenshot home + /toernooi NL+EN, admin lijst + tekst-namespace), `npm run build` groen (route `/[locale]/toernooi` aanwezig). **Nog committen + deployen.**
